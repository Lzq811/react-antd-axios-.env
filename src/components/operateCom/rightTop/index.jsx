...
export default class Rent extends Component {
  ...
  initLineChart = () => {
    let mychart = echarts.init(document.getElementById('operate-about-trend-chart'))
  ...
  render () {
    ...
    return (
      <div className='rigth-top-wrap'>
        <Border width={460} height={644} lineList={lineList} title={'经营相关指数走势'} unit={'(近6个月)'} size={14}></Border>
        <div id='operate-about-trend-chart' className='chart-ele' style={{height: '600px', width: '460px'}}></div>
      </div>
    )
  }
}